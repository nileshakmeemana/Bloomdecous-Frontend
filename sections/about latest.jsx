        ...
        <>
            ...
            <section className="flex flex-col items-center justify-center mt-20">
                <div className="max-md:px-4">
                    <p className="bg-gradient-to-r from-slate-800 to-[#4D6EA3] text-transparent bg-clip-text text-3xl text-left font-medium max-w-2xl">Why do 500+ companies choose to integrate our features?</p>
