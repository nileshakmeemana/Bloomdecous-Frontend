    ...
    return (
        <section className="py-20 flex flex-col items-center justify-center" id="contact-us">
            <form className="flex flex-col items-center text-sm text-slate-800">
                <p className="text-xs bg-[#b19316] text-white font-medium px-3 py-1 rounded-full">Check Booking</p>
                <h1 className="text-4xl font-bold py-4 text-center">Let’s Get In Touch.</h1>
                <p className="max-md:text-sm text-gray-500 pb-10 text-center">
                    Or just reach out manually to us at <a href="/" className="text-[#b19316] hover:underline">hello@Bloomadecous.com</a>
                </p>
            
                <div className="max-w-96 w-full px-4">
                    <label htmlFor="email-address" className="font-medium mt-4">Email Address</label>
                    <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-1 focus-within:ring-[#b19316] transition-all overflow-hidden">
                    ...
                    <label htmlFor="name" className="font-medium">Subject</label>
                    <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-1 focus-within:ring-[#b19316] transition-all overflow-hidden">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M18.311 16.406a9.64 9.64 0 0 0-4.748-4.158 5.938 5.938 0 1 0-7.125 0 9.64 9.64 0 0 0-4.749 4.158.937.937 0 1 0 1.623.938c1.416-2.447 3.916-3.906 6.688-3.906 2.773 0 5.273 1.46 6.689 3.906a.938.938 0 0 0 1.622-.938M5.938 7.5a4.063 4.063 0 1 1 8.125 0 4.063 4.063 0 0 1-8.125 0" fill="#475569"/>
                        </svg>
                    ...
                    <textarea rows="4" className="w-full mt-2 p-2 bg-transparent border border-slate-300 rounded-lg resize-none outline-none focus:ring-1 focus-within:ring-[#b19316] transition-all" placeholder="Enter your message" required></textarea>
            
                    <button type="submit" className="btn flex items-center justify-center gap-1 mt-5 hover:bg-indigo-600 text-white py-2.5 w-full rounded-full transition">
                        Submit Form
