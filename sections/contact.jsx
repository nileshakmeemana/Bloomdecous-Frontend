    ...
    return (
        <section className="py-20 flex items-center justify-center w-full">
            <form className="flex flex-col items-center text-sm">
                ...
                <p className="text-sm text-gray-500 text-center pb-10">Have an event coming up? We’d love to help bring your vision to life.<br />Reach out to Bloomdecous to discuss your event details.</p>
