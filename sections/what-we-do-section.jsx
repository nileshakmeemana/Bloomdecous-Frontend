    ...
    return (
        <section className="flex flex-col md:flex-row items-center justify-center gap-20 mt-20">
            <div className="relative shadow-2xl shadow-indigo-600/40 rounded-2xl overflow-hidden shrink-0">
                ...
                <div className="flex items-center gap-1 max-w-72 absolute bottom-8 left-8 bg-white p-4 rounded-xl">
                    <div className="flex -space-x-4 shrink-0">
                        ...
                        <div
                            className="flex items-center justify-center text-xs  text-white size-9 rounded-full border-[3px] border-white bg-pink-600 hover:-translate-y-1 transition z-[4]">
                            50+
                        </div>
                    </div>
            ...
            <div className="text-sm text-slate-600 max-w-md">
                ...
                <div className="w-24 h-[3px] rounded-full bg-gradient-to-r from-pink-400 to-red-500"></div>
